...
addItem({'name':'Cardigan de Harry Styles',
...
addItem({'name':'Cardigan de Taylor Swift',
...
addItem({'name':'Mítica Versace de Luis Miguel',
...
addItem({'name':'Sweater de Lana del Rey',
...
addItem({'name':'Sweater de One Direction',
